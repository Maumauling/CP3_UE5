...
extern __global__ void prod_gpu(double *v, double *a, double *b, int nx, int ny);
extern __global__ void vec_add_gpu(double *p, double *r, double b, double *s, int nx, int ny);
